...
export default {
  ...
  methods: {
    ...mapActions({
      'showModal': 'showModal',
      'hideModal': 'hideModal',
      'fetchPage': 'mileageFaultList/fetchPage',
      'fetchRecord': 'mileageFaultList/fetchRecord'
    }),
  ...
  computed: {
    formatRows: function () {
      return this.$store.state.mileageFaultList.list.map(value => {
        return {
          ...value,
    ...
    pagination: function () {
      return {
        total: this.$store.state.mileageFaultList.total,
        pageSize: this.$store.state.mileageFaultList.pageSize,
        currentPage: this.$store.state.mileageFaultList.currentPage,
      }
    }
