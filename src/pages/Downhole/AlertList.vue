...
export default {
  ...
  methods: {
    ...mapActions({
      ...
      'showModal': 'showModal',
      'hideModal': 'hideModal',
      'fetchPage': 'downholeAlertList/fetchPage',
      'fetchRecord': 'downholeAlertList/fetchRecord',
    ...
    processDelete: function () {
      this.showModal({
        ...
        onConfirm: async () => {
          ...
          await this.deleteAlert({ids, type:  PageTypeEnum.DOWNHOLE});
          this.fetchPageWithQuery();
        },
        onCancel: () => {
          this.hideModal();
  ...
  computed: {
    formatRows: function () {
      return this.$store.state.downholeAlertList.list.map(value => {
    ...
    pagination: function () {
      return {
        total: this.$store.state.downholeAlertList.total,
        pageSize: this.$store.state.downholeAlertList.pageSize,
        currentPage: this.$store.state.downholeAlertList.currentPage,
      }
    },
  }
}
