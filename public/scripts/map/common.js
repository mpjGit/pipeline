...
const ALARM_TYPE = {
    ...
    TROUBLE_CODE_LASER_LINK_ABNORMAL: '通信异常',
    TROUBLE_CODE_LASER_TEMP_PRS_LINK_ABNORMAL: '激光器内部稳压通信异常',
    TROUBLE_CODE_LASER_TEMPERATURE: '温度异常',
    TROUBLE_CODE_LASER_UNCALIBRATED: '未标定',
    TROUBLE_CODE_LASER_WEAK_LIGHT: '光过弱',
    TROUBLE_CODE_LASER_STRONG_LIGHT: '光过强',
    TROUBLE_CODE_LASER_ABSORPTION_PEAK_ABNORMAL: '吸收峰异常',
    TROUBLE_CODE_OPERATION_PARAM_ABNORMAL: '操作参数异常',
    TROUBLE_CODE_SYSTEM_REPORT_DATA_ABNORMAL: '系统参数异常',
    TROUBLE_CODE_LASER_LOST_LINK: '激光器断开连接',
}
